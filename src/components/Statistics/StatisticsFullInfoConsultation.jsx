            ...
            <table className="cons-big-table-title">
              <thead>
                <tr>
                  ...
                  <th className="cons-full-data-size">
                    Відвідувач / Хворий
                  </th>
                  <th className="cons-full-data-size1">
                    Лікар
                  </th>
                  <th className="cons-full-data-size3">Платно</th>
                  <th className="cons-full-data-size3">Знижка %</th>
              ...
              <tbody>
                {data[date].map((consultation) => (
                  <tr key={consultation.id} className="cons-big-container-data-full">
                    <td className="cons-big-container-data-size1">
                      <p className="data-receipt_number">{consultation.receipt_number}</p>
                    </td>
