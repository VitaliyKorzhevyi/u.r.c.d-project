...
export const SECTION_PERMISSIONS = {
  "main-page": [
    ...
    PERMISSIONS.VIEW_INFORMATION_MESSAGES,
  ], 
  users: [
  ...
  "create-report": [
    PERMISSIONS.CREATE_PREOPERATIVE_DAY,
    PERMISSIONS.CREATE_DIAGNOSIS,
    PERMISSIONS.CREATE_OPERATION,
    PERMISSIONS.CREATE_PATIENT,
    PERMISSIONS.CREATE_MEDICAMENT,
